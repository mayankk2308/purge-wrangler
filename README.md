...
**Note**: The blue badge above indicates the latest public release. **Only use that**, and not files from the HEAD of the repository.
...
| **Intel**, **AMD** | NVIDIA | NVIDIA Web Drivers | Mostly working setups, though some macs may encounter black screens/lag/distortions on monitors connected to the eGPU. See [more tools](https://github.com/mayankk2308/purge-wrangler#more-tools) for additional workarounds. |
