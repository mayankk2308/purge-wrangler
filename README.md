...
| :-----------: | :---------: | :---------- |
| **macOS** | 10.13.4+ | Use [automate-eGPU.sh](https://github.com/goalque/automate-eGPU) for older macOS versions. Also read **Apple's** [external GPU support document](https://support.apple.com/en-us/HT208544). |
